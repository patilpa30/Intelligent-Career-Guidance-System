...
@app.route('/redirect_to_php/<job>')
def redirect_to_php(job):
    # Assuming your PHP files are located in a directory named 'php_career_files'
    php_file_path = f"http://localhost/INTELLIGENT-CAREER-GUIDANCE-SYSTEM/{job.replace(' ', '_')}.php"
    print("Redirecting to:", php_file_path)  # Add this line
    return redirect(php_file_path)
