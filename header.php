					...
					<ul class="main-menu nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-content">
								<a href="http://localhost/INTELLIGENT-CAREER-GUIDANCE-SYSTEM/login.php">Career Prediction</a>
                                <a href="http://localhost/INTELLIGENT-CAREER-GUIDANCE-SYSTEM/courses.php">Courses</a>
                                <a href="http://localhost/INTELLIGENT-CAREER-GUIDANCE-SYSTEM/blog.php">Knowledge Network</a>
